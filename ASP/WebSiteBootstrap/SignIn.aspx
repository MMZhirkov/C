            ...
            <div class="form-horizontal">
                ...
                <div class="form-group">
                    ...
                    <div class="col-md-6">
                      ...
                      <asp:LinkButton ID="LinkButton1" runat="server" PostBackUrl="~/UserHome.aspx" CausesValidation="False">Sign Up</asp:LinkButton>
                    </div>
                </div>
                <div class="form-group">
                    <div class="col-md-2"></div>
                    <div class="col-md-6">
                        <asp:LinkButton ID="LLbForgorPass" runat="server" PostBackUrl="~/ForgotPassword.aspx">Forgot Password</asp:LinkButton>
                    </div>
                </div>
                <div class="form-group">
                    <div class="col-md-2"></div>
