    ...
    protected void btPassRec_Click(object sender, EventArgs e)
    {
        ...
        using (SqlConnection con = new SqlConnection(CS))
        {
            ...
            if (dt.Rows.Count != 0)
            {
                ...
                String EmailBody = "Hi " + Username + ",<br/><br/> Click the link below to reset your password <br/><br/> http://localhost:50193/RecoverPassword.aspx?Uid=" + myGUID;
                MailMessage PassRecMail = new MailMessage("zhirkovmichael@gmail.com", ToEmailAddress);
                ...
                {
                    UserName = "zhirkovmichael@gmail.com",
